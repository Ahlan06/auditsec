...
export const sendOrderConfirmationEmail = async (order) => {
  try {
    ...
    const mailOptions = {
      from: process.env.FROM_EMAIL || 'noreply@zerodayshop.com',
      to: order.customerEmail,
      subject: `🔐 ZeroDay Shop - Your Order ${order.orderId} is Ready!`,
      html: emailHtml
    };
...
const generateOrderEmailTemplate = (order, downloadLinks) => {
  ...
  <head>
    ...
    <title>ZeroDay Shop - Order Confirmation</title>
    <style>
      body {
  ...
  <body>
    <div class="container">
      <div class="header">
        <div class="logo">ZeroDay Shop</div>
...
> Access granted. Happy hacking! <
      ...
      <div class="footer">
        ...
        <p><small>ZeroDay Shop - Empowering Ethical Hackers</small></p>
      </div>
    </div>
  </body>
  </html>
