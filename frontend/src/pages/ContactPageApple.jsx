...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // EmailJS configuration - IMPORTANT: Replace these values with your real keys
      // See EMAILJS_CONFIG_GUIDE.md for complete instructions
      const serviceId = import.meta.env.VITE_EMAILJS_SERVICE_ID || 'service_auditsec';
      ...
      if (publicKey === 'YOUR_PUBLIC_KEY') {
        console.error('⚠️ EmailJS non configuré. Voir EMAILJS_CONFIG_GUIDE.md');
